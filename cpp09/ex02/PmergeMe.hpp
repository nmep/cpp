# ifndef PMERGEME_HPP
	...
	// FJ for deque
	bool	ft_merge_sort_max_element_deque(std::deque<unsigned long long> *d, d_it start, d_it end, std::deque<unsigned long long> *max_elements);
	...
	// FJ for vector
	bool	ft_merge_sort_max_element_vector(std::vector<unsigned long long> *v, v_it start, v_it end, std::vector<unsigned long long> *max_elements);
